        ...
        while($data = mysqli_fetch_array($result)){
            ...
            foreach($list_vehicule as $vehicule){
                ...
                $html .= '<tr>
                            ...
                            <th class="col-1 text-center align-middle"><a type="" onclick="interventionNonOk('.$interv.');" class="" href="../templates/liste_interventions.html">Intervention terminée</a></th>
                        </tr>';
                $status = 1;
                }
            }
