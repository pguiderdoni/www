...
public function __construct ($id){
    ...
    $requete = "UPDATE `users` SET `nom`='". mysqli_real_escape_string($GLOBALS['Database'],$this->nom) ."', `prenom`='". mysqli_real_escape_string($GLOBALS['Database'],$this->prenom) ."',`login`='". mysqli_real_escape_string($GLOBALS['Database'],$this->login) ."',`date_password`='". mysqli_real_escape_string($GLOBALS['Database'],$datePassword) ."',`password`='". mysqli_real_escape_string($GLOBALS['Database'],$this->password)."' WHERE `id_user`='". $this->id ."'";
    error_log($requete);
    mysqli_query($GLOBALS['Database'], $requete) or die;
    }
